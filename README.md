...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytool-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14304&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytool-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytool` can be installed with:

```
conda install pytool
```

It is possible to list all of the versions of `pytool` available on your platform with:
